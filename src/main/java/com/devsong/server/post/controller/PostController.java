...
public class PostController {
    ...
    //게시글 목록 조회
    @Operation(summary = "게시물 조회 (10개씩 페이징)")
    @GetMapping
    ...
    //게시글 좋아요 누르기 및 취소하기
    @Operation(summary = "게시물에 좋아요 누르기 및 취소")
    @PostMapping("/like")
    ...
    //게시글 수정
    @Operation(summary = "게시물 제목 또는 내용 수정")
    @PostMapping("/update")
